...
from voice_conversion.Utils.networks import discriminator_cbgan, generator
from voice_conversion.Utils.losses import *
...
class CycleBeGAN(object):
    ...
    def __init__(self, num_features, discriminator=discriminator_cbgan, generator=generator, mode='train',
        ...
        self.saver = tf.compat.v1.train.Saver() #save checkpoint
